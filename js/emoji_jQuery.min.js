! function(e) {
		...
		e.extend({
			Lemoji: function(n) {
				...
				var c = e.extend({}, {
					...
					d = "",
					h = 0;
				e.map(c.emojis, function(e, t) {
					d += '<li data-index="' + h + '">' + e.name + "</li>", h++
				}), p.append("<ul>" + d + "</ul>"), f.append(u.append(l)).append(p).appendTo("body"), u.on("click", "li",
					function() {
				...
				var m = !0;
				e(c.emojiBtn).on("click", function(t) {
					m ? (f.show("slow", function() {
			...
			emojiParse: function(t) {
				...
				function a(e, t, n, o) {
					var i = new RegExp("\\[\\" + t + "[\\u4e00-\\u9fa5]+\\]", "g"),
						a = e.match(i);
					if (a)
						for (var s = new RegExp("^\\[\\" + t), c = /\]$/, l = 0; l < a.length; l++) {
			...
			return this.map(function(t) {
				var n = function(e, t) {
					...
					if (t && "function" == typeof btoa) {
						var r = (n = i, "/*# sourceMappingURL=data:application/json;charset=utf-8;base64," + btoa(unescape(
	...
	function v(e, t) {
		...
		if (t.singleton) {
			var a = l++;
			n = c || (c = b(t)), o = x.bind(null, n, a, !1), i = x.bind(null, n, a, !0)
			...
			.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (n = function(e) {
				...
				return void 0 === e.attrs.type && (e.attrs.type = "text/css"), e.attrs.rel = "stylesheet", g(t, e.attrs), h(e, t),
					t
			}(t), o = function(e, t, n) {
				var o = n.css,
					i = n.sourceMap,
					r = void 0 === t.convertToAbsoluteUrls && i;
				(t.convertToAbsoluteUrls || r) && (o = u(o)), i && (o += "\n/*# sourceMappingURL=data:application/json;base64," +
	...
	e.exports = function(e) {
		...
		return e.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(e, t) {
			...
			return /^(#|data:|http:\/\/|https:\/\/|file:\/\/\/|\s*$)/i.test(r) ? e : (i = 0 === r.indexOf("//") ? r : 0 ===
				r.indexOf("/") ? n + r : o + r.replace(/^\.\//, ""), "url(" + JSON.stringify(i) + ")")
		})
	}
}, function(e, t) {
	e.exports = {
	...
	e.exports = function(e, t, n) {
		...
		function i(e, t, n, o, i) {
			...
			var r = 0,
				a = "",
				s = "";
			return $.map(e, function(c, l) {
				var f = o + l + t;
				if (r < i ? a += '<li data-code="' + n + '" data-emojiImg="' + f + '" title="' + c + '"><img src="' + f +
					'" width="25" height="25" /></li>' : (s += "<ul>" + a + "</ul>", r = 0, a = "", a += '<li data-code="' + n +
						'" data-emojiImg="' + f + '" title="' + c + '"><img src="' + f + '" width="25" height="25" /></li>'), Object
					.keys(e).length === parseInt(l)) {
					for (var u = i - r, p = 0; p < u - 1; p++) a += '<li data-code="' + n +
						'"><img src="#" width="25" height="25" style="visibility: hidden;"></li>';
					s += "<ul>" + a + "</ul>"
				}
				r++
			}), '<div  class="emoji_item">' + s + "</div>"
		}
		return $.map(e, function(r, a) {
			var s;
			switch (a = a.toLowerCase()) {
				case "qq":
					s = i(t[a], ".png", ":", e[a].path, n), o += s;
					break;
				case "tieba":
					s = i(t[a], ".png", ";", e[a].path, n), o += s;
					break;
	...
	e.exports = function(e, t) {
		if ((e = e[0]).focus(), document.selection) document.selection.createRange().text = t;
			...
			var n = e.selectionStart,
				...
				i = n,
				r = e.value;
			e.value = r.substring(0, n) + t + r.substring(o, r.length), i += t.length, e.selectionStart = e.selectionEnd = i
		} else e.value += t
	}
}, function(e, t) {
	e.exports = function(e, t, n) {
